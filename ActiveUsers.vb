...
Namespace WikiBot
    ...
    Public Class ActiveUsers
        ...
        Sub CheckUsersActivity(ByVal TemplatePage As Page, ByVal PageToSave As Page)
            ...
            Dim InactiveUsers As New List(Of WikiUser)
            For Each p As Page In _bot.GetallInclusionsPages(TemplatePage)
                ...
                If (p.PageNamespace = 3) Or (p.PageNamespace = 2) Then
                    ...
                    If Date.Now.Subtract(User.LastEdit) < New TimeSpan(0, 30, 0) Then
                        If Not ActiveUsers.Contains(User) Then
            ...
            t.Name = "#switch:{{{1|}}}"
            t.Parameters.Add(New Tuple(Of String, String)("", "'''Error''': el parámetro 1 está vacío"))
            ...
            For Each u As WikiUser In ActiveUsers
                t.Parameters.Add(New Tuple(Of String, String)(u.UserName, "[[Archivo:WX circle green.png|10px|link=]]&nbsp;<span style=""color:green;"">'''Conectado'''</span>"))
            Next
            For Each u As WikiUser In InactiveUsers
                Dim lastedit As Date = u.LastEdit
                t.Parameters.Add(New Tuple(Of String, String)(u.UserName, "[[Archivo:WX circle red.png|10px|link=|Última edición el " & Integer.Parse(lastedit.ToString("dd")).ToString & lastedit.ToString(" 'de' MMMM 'de' yyyy 'a las' HH:mm '(UTC)'", New System.Globalization.CultureInfo("es-ES")) & "]]&nbsp;<span style=""color:red;"">'''Desconectado'''</span>"))
            Next
